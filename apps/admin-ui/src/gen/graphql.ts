...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getConsumerOrderDetail(variables: GetConsumerOrderDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetConsumerOrderDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetConsumerOrderDetailQuery>(GetConsumerOrderDetailDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getConsumerOrderDetail', 'query');
    },
    cancelConsumerOrderMutation(variables: CancelConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CancelConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CancelConsumerOrderMutationMutation>(CancelConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'cancelConsumerOrderMutation', 'mutation');
    },
    confirmConsumerOrderMutation(variables: ConfirmConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ConfirmConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ConfirmConsumerOrderMutationMutation>(ConfirmConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'confirmConsumerOrderMutation', 'mutation');
    },
    prepareConsumerOrderMutation(variables: PrepareConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<PrepareConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PrepareConsumerOrderMutationMutation>(PrepareConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'prepareConsumerOrderMutation', 'mutation');
    },
    shipConsumerOrderMutation(variables: ShipConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ShipConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ShipConsumerOrderMutationMutation>(ShipConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'shipConsumerOrderMutation', 'mutation');
    },
    deliverConsumerOrderMutation(variables: DeliverConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeliverConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeliverConsumerOrderMutationMutation>(DeliverConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'deliverConsumerOrderMutation', 'mutation');
    },
    refundConsumerOrderMutation(variables: RefundConsumerOrderMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RefundConsumerOrderMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<RefundConsumerOrderMutationMutation>(RefundConsumerOrderMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'refundConsumerOrderMutation', 'mutation');
    },
    getConsumerOrdersForAdmin(variables?: GetConsumerOrdersForAdminQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetConsumerOrdersForAdminQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetConsumerOrdersForAdminQuery>(GetConsumerOrdersForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getConsumerOrdersForAdmin', 'query');
    },
    getStockDetail(variables: GetStockDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetStockDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetStockDetailQuery>(GetStockDetailDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getStockDetail', 'query');
    },
    getStockMovementsForDetail(variables: GetStockMovementsForDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetStockMovementsForDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetStockMovementsForDetailQuery>(GetStockMovementsForDetailDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getStockMovementsForDetail', 'query');
    },
    receiveStockMutation(variables: ReceiveStockMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ReceiveStockMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ReceiveStockMutationMutation>(ReceiveStockMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'receiveStockMutation', 'mutation');
    },
    adjustStockMutation(variables: AdjustStockMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AdjustStockMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<AdjustStockMutationMutation>(AdjustStockMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'adjustStockMutation', 'mutation');
    },
    issueStockMutation(variables: IssueStockMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<IssueStockMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<IssueStockMutationMutation>(IssueStockMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'issueStockMutation', 'mutation');
    },
    updateReorderPointMutation(variables: UpdateReorderPointMutationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UpdateReorderPointMutationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateReorderPointMutationMutation>(UpdateReorderPointMutationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'updateReorderPointMutation', 'mutation');
    },
    getInventoryList(variables?: GetInventoryListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetInventoryListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetInventoryListQuery>(GetInventoryListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getInventoryList', 'query');
    },
    getProductStockForList(variables: GetProductStockForListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProductStockForListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductStockForListQuery>(GetProductStockForListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProductStockForList', 'query');
    },
    clientDetail(variables: ClientDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ClientDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClientDetailQuery>(ClientDetailDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'clientDetail', 'query');
    },
    createClientForClientsList(variables: CreateClientForClientsListMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateClientForClientsListMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateClientForClientsListMutation>(CreateClientForClientsListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createClientForClientsList', 'mutation');
    },
    clientListPage(variables?: ClientListPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ClientListPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ClientListPageQuery>(ClientListPageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'clientListPage', 'query');
    },
    consumerCustomersForAdmin(variables?: ConsumerCustomersForAdminQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ConsumerCustomersForAdminQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ConsumerCustomersForAdminQuery>(ConsumerCustomersForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'consumerCustomersForAdmin', 'query');
    },
    productDetail(variables: ProductDetailQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ProductDetailQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ProductDetailQuery>(ProductDetailDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'productDetail', 'query');
    },
    ...
    getProductImageUploadUrl(variables: GetProductImageUploadUrlMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProductImageUploadUrlMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProductImageUploadUrlMutation>(GetProductImageUploadUrlDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProductImageUploadUrl', 'mutation');
    },
    confirmProductImageUpload(variables: ConfirmProductImageUploadMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ConfirmProductImageUploadMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ConfirmProductImageUploadMutation>(ConfirmProductImageUploadDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'confirmProductImageUpload', 'mutation');
    },
    getProuctsForAdmin(variables: GetProuctsForAdminQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProuctsForAdminQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProuctsForAdminQuery>(GetProuctsForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProuctsForAdmin', 'query');
    },
    getProuctForProductsList(variables: GetProuctForProductsListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProuctForProductsListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProuctForProductsListQuery>(GetProuctForProductsListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getProuctForProductsList', 'query');
    },
    QuotesList(variables?: QuotesListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<QuotesListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<QuotesListQuery>(QuotesListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'QuotesList', 'query');
    },
    CreateQuotePdf(variables: CreateQuotePdfMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateQuotePdfMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateQuotePdfMutation>(CreateQuotePdfDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateQuotePdf', 'mutation');
    },
    recentOrder(variables?: RecentOrderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<RecentOrderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RecentOrderQuery>(RecentOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'recentOrder', 'query');
    },
    detailOrderForSearch(variables?: DetailOrderForSearchQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DetailOrderForSearchQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DetailOrderForSearchQuery>(DetailOrderForSearchDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'detailOrderForSearch', 'query');
    },
    detailOrder(variables: DetailOrderQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DetailOrderQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DetailOrderQuery>(DetailOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'detailOrder', 'query');
    },
    CreateDeliveryNotePdf(variables: CreateDeliveryNotePdfMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateDeliveryNotePdfMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateDeliveryNotePdfMutation>(CreateDeliveryNotePdfDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateDeliveryNotePdf', 'mutation');
    },
    currentMonthlyRevenue(variables: CurrentMonthlyRevenueQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CurrentMonthlyRevenueQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CurrentMonthlyRevenueQuery>(CurrentMonthlyRevenueDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'currentMonthlyRevenue', 'query');
    },
    currentWeeklyRevenue(variables: CurrentWeeklyRevenueQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CurrentWeeklyRevenueQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CurrentWeeklyRevenueQuery>(CurrentWeeklyRevenueDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'currentWeeklyRevenue', 'query');
    },
    getDailySales(variables: GetDailySalesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetDailySalesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDailySalesQuery>(GetDailySalesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getDailySales', 'query');
    },
    getMonthlySales(variables: GetMonthlySalesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMonthlySalesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMonthlySalesQuery>(GetMonthlySalesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getMonthlySales', 'query');
    },
    getTopSkus(variables: GetTopSkusQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetTopSkusQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTopSkusQuery>(GetTopSkusDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getTopSkus', 'query');
    },
    getCustomerSales(variables: GetCustomerSalesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCustomerSalesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCustomerSalesQuery>(GetCustomerSalesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getCustomerSales', 'query');
    },
    getChannelSales(variables: GetChannelSalesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetChannelSalesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetChannelSalesQuery>(GetChannelSalesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getChannelSales', 'query');
    },
    getSalesAnalyticsV2Dashboard(variables: GetSalesAnalyticsV2DashboardQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSalesAnalyticsV2DashboardQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSalesAnalyticsV2DashboardQuery>(GetSalesAnalyticsV2DashboardDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getSalesAnalyticsV2Dashboard', 'query');
    },
    GetProviderConfigForSettings(variables: GetProviderConfigForSettingsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetProviderConfigForSettingsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetProviderConfigForSettingsQuery>(GetProviderConfigForSettingsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetProviderConfigForSettings', 'query');
    },
    getCouponsForAdmin(variables: GetCouponsForAdminQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetCouponsForAdminQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetCouponsForAdminQuery>(GetCouponsForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getCouponsForAdmin', 'query');
    },
    createCouponForAdmin(variables: CreateCouponForAdminMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateCouponForAdminMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateCouponForAdminMutation>(CreateCouponForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createCouponForAdmin', 'mutation');
    },
    disableCouponForAdmin(variables: DisableCouponForAdminMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DisableCouponForAdminMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DisableCouponForAdminMutation>(DisableCouponForAdminDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'disableCouponForAdmin', 'mutation');
    },
    getPickupOrders(variables?: GetPickupOrdersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPickupOrdersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPickupOrdersQuery>(GetPickupOrdersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getPickupOrders', 'query');
    },
    readyOrder(variables: ReadyOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<ReadyOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<ReadyOrderMutation>(ReadyOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'readyOrder', 'mutation');
    },
    pickupOrder(variables: PickupOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<PickupOrderMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<PickupOrderMutation>(PickupOrderDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pickupOrder', 'mutation');
    },
    cancelOrder(variables: CancelOrderMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CancelOrderMutation> {
    ...
    TenantListPage(variables?: TenantListPageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<TenantListPageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TenantListPageQuery>(TenantListPageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'TenantListPage', 'query');
    },
    ...
    DeleteOperator(variables: DeleteOperatorMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<DeleteOperatorMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteOperatorMutation>(DeleteOperatorDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'DeleteOperator', 'mutation');
    },
    GetPlatformManifestTemplate(variables?: GetPlatformManifestTemplateQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPlatformManifestTemplateQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPlatformManifestTemplateQuery>(GetPlatformManifestTemplateDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPlatformManifestTemplate', 'query');
    },
    SaveManifest(variables: SaveManifestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SaveManifestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SaveManifestMutation>(SaveManifestDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'SaveManifest', 'mutation');
    },
    CopyOperatorManifest(variables: CopyOperatorManifestMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CopyOperatorManifestMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CopyOperatorManifestMutation>(CopyOperatorManifestDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CopyOperatorManifest', 'mutation');
    },
    GetOAuthConfigs(variables?: GetOAuthConfigsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetOAuthConfigsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetOAuthConfigsQuery>(GetOAuthConfigsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetOAuthConfigs', 'query');
    },
    CheckAliasAvailability(variables: CheckAliasAvailabilityMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CheckAliasAvailabilityMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CheckAliasAvailabilityMutation>(CheckAliasAvailabilityDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CheckAliasAvailability', 'mutation');
    },
    getTenantList(variables?: GetTenantListQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetTenantListQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetTenantListQuery>(GetTenantListDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getTenantList', 'query');
    },
    accountMenuContent(variables: AccountMenuContentQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<AccountMenuContentQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AccountMenuContentQuery>(AccountMenuContentDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'accountMenuContent', 'query');
    },
    ...
    GetConnectedOAuthProviders(variables: GetConnectedOAuthProvidersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetConnectedOAuthProvidersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetConnectedOAuthProvidersQuery>(GetConnectedOAuthProvidersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetConnectedOAuthProviders', 'query');
    }
  };
}
