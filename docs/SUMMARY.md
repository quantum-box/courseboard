...
- [In Progress]()
  ...
  - [メンバーへの policy 単位の権限付与](src/tasks/in-progress/permission-policy-granularity/task.md)
  ...
  - [/v1/me proxyとextension連動テナント選択](src/tasks/in-progress/v1-me-proxy-extension-filter/task.md)
    - [設計](src/tasks/in-progress/v1-me-proxy-extension-filter/design.md)
  ...
  - [日別予約状況の取り込み（撤去済み）](src/tasks/in-progress/reservation-summary-import/task.md)
