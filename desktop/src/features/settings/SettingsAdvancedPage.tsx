...
export function SettingsAdvancedPage() {
  ...
  return (
    <SettingsSubPage>
      ...
      {/* Config held in the extension rather than in CourseBoard's own store,
          which is where ADR-0009 is taking it. Kept beside the extension's own
          status while it is still the thing being read. */}
