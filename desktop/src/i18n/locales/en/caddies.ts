...
export const caddies: DeepPartial<typeof source> = {
  ...
  calendar: {
    ...
    guide: {
      ...
      body: 'For consecutive days, pick the first day and close the editor, then hold Shift and pick the last. Use Edit selected days to save the whole range together.',
    ...
    editSelection: 'Edit selected days',
  ...
  payroll: {
    ...
    feeAlignment: {
      open: 'Move to rank fees',
      title: 'Move own fees onto rank fees',
      description: 'Clears the fee each caddie was registered with so their rank pays them instead. Choose who moves, one caddie at a time.',
      loading: 'Loading caddies with their own fee',
      unconfirmed: {
        title: 'The rank fees have not been saved',
        description: 'Nobody can be moved onto a table the club has not confirmed. Check the amounts under “Set the fees” and save them first.',
      },
      empty: {
        title: 'No caddie carries a fee of their own',
        description: 'Everyone is paid by their rank.',
      },
      counts: '{{cut}} paid less · {{raise}} paid more · {{unchanged}} unchanged',
      effect: {
        cut: 'Paid less',
        raise: 'Paid more',
        unchanged: 'Unchanged',
      },
      perRound: '({{amount}} per round)',
      inactive: 'No longer active',
      unpriced: 'Rank {{rank}} pays 0, so nobody can move onto it',
      cutWarning: {
        title: '{{count}} caddies will be paid less',
        description: 'The caddies you ticked lose {{amount}} per round between them. Make sure none was hired on their own terms without the club agreeing to this.',
      },
      scope: {
        title: 'Past months are re-priced too',
        description: 'Pay is worked out from the fees as they stand now, so a caddie you move shows their rank fee in closed months as well.',
      },
      noteLabel: 'Reason (kept in the change log)',
      notePlaceholder: 'e.g. Agreed with the manager on 1 Sep',
      submit: 'Move {{count}} to rank fees',
      submitting: 'Moving…',
      failed: 'Could not move caddies onto rank fees',
      done: {
        title: 'Moved onto rank fees',
        message: 'Moved {{aligned}}. Not moved: {{skipped}}.',
      },
      outcome: {
        aligned: 'Moved',
        already_on_rank: 'Already paid by rank',
        own_fee_changed: 'Their fee changed after this list was opened. Reopen it and check',
        not_found: 'Caddie not found',
        rank_unpriced: 'Their rank pays 0',
        failed: 'Could not save',
      },
      history: {
        title: 'Change log',
        empty: 'Nobody has been moved yet.',
        entry: '{{from}} → rank {{rank}} ({{to}})',
        unknownCaddie: 'Caddie no longer on the roster',
      },
    },
    table: {
      caddie: 'Caddie',
