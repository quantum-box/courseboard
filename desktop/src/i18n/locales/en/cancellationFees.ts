...
export const cancellationFees: DeepPartial<typeof source> = {
  ...
  new: {
    ...
    client: {
      title: 'Billed to',
      description: 'Typing a name offers candidates from the customer ledger. A recipient who is not in it can still be invoiced with a name and a phone number.',
      kind: 'Recipient type',
      person: 'Person',
      company: 'Company',
      name: 'Client name',
      nameHint: 'Pick a candidate for somebody the ledger already holds. Left unpicked, the invoice goes out to the name as typed.',
      id: 'Client ID',
      idPlaceholder: 'cl_...',
    ...
    validation: {
      ...
      billTo: 'Enter the recipient’s name. Billing a company also needs a client ID.',
    },
    message: {
