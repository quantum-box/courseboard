...
export const reservationReportImport: DeepPartial<typeof source> = {
  ...
  mapping: {
    title: 'Map facilities to CourseBoard courses',
    description: 'Choose one destination course for each facility in the report. We suggest exact name matches; check every choice.',
    source: 'Report facility',
    selected: 'Selected',
    unselected: 'Choose a course',
    suggested: 'Name match suggested',
    columnTitle: 'Review the column mapping',
    columnDescription: 'These report columns were mapped to the fields CourseBoard will save. Check them before choosing destination courses.',
