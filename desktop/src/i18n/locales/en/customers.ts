...
export const customers: DeepPartial<typeof source> = {
  ...
  cancellations: {
    ...
    bill: {
      ...
      unregistered: 'Invoiced to this name as a recipient who is not in the ledger.',
      ...
      unlinkedTitle: 'Bookings with no ledger link',
      unlinkedHint: 'Typing a name offers candidates from the ledger. Pick one to bill that customer, or leave it to bill the name as typed.',
      unlinkedBooking: '{{date}} · {{players}} players',
      unlinkedName: 'Recipient name',
      unlinkedPhone: 'Phone number',
