...
export const caddies: DeepPartial<typeof source> = {
  ...
  supply: {
    ...
    unfiled: {
      working: '{{n}}人は、この日に出られるかをまだ出していません。いまは出る人として数えているので、出せる組の数は本当より多いかもしれません。',
      off: '{{n}}人は、この日に出られるかをまだ出していません。いまは休む人として数えているので、出してもらえば出せる組の数が増えます。',
    },
  },
  autoAssign: {
    title: '自動で担当を決める',
  ...
  calendar: {
    ...
    guide: {
      ...
      body: '続く日にまとめて入れるときは、最初の日を押して入力する画面を閉じ、Shift キーを押しながら最後の日を押します。「選んだ日に希望を入れる」からまとめて保存できます。',
  ...
  payroll: {
    ...
    feeAlignment: {
      open: 'ランクの金額にそろえる',
      title: 'この人だけの金額を、ランクの金額にそろえる',
      description: '登録したときに入れた、この人だけの金額をやめて、ランクごとの金額で払うようにします。そろえるかどうかは、一人ずつ選びます。',
      loading: 'この人だけの金額を読み込んでいます',
      unconfirmed: {
        title: 'ランクごとの金額がまだ保存されていません',
        description: 'そろえる先の金額が決まっていないので、まだそろえられません。「金額を決める」で金額を確かめて保存してください。',
      },
      empty: {
        title: 'この人だけの金額を持つ人はいません',
        description: '全員がランクごとの金額で計算されています。',
      },
      counts: '下がる人 {{cut}}人・上がる人 {{raise}}人・変わらない人 {{unchanged}}人',
      effect: {
        cut: '下がる',
        raise: '上がる',
        unchanged: '変わらない',
      ...
      perRound: '（1回 {{amount}}）',
      inactive: 'いまは働いていません',
      unpriced: 'ランク {{rank}} の金額が 0 円なので、そろえられません',
      cutWarning: {
        title: '{{count}}人の払う金額が下がります',
        description: '選んだ人の金額が、1回あたり合わせて {{amount}} 下がります。特別な約束で働いている人が入っていないか、現場で話がついているかを確かめてください。',
      },
      scope: {
        title: '前の月にも反映されます',
        description: '払う金額はいまの金額で計算しなおすので、そろえた人は、もう終わった月の合計もランクの金額で表示されます。',
      },
      noteLabel: '理由（記録に残ります）',
      notePlaceholder: '例: 9/1 支配人と話がついた',
      submit: '{{count}}人をランクの金額にそろえる',
      submitting: 'そろえています…',
      failed: 'ランクの金額にそろえられませんでした',
      done: {
        title: 'ランクの金額にそろえました',
        message: '{{aligned}}人をそろえました。そろえなかった人: {{skipped}}人',
      },
      outcome: {
        aligned: 'そろえました',
        already_on_rank: 'もうランクの金額で計算されています',
        own_fee_changed: '画面を開いたあとに金額が変わったので、そろえていません。開きなおして確かめてください',
        not_found: 'この人が見つかりません',
        rank_unpriced: 'ランクの金額が 0 円なので、そろえていません',
        failed: '保存できませんでした',
      },
      history: {
        title: 'これまでの記録',
