...
export const cancellationFees: DeepPartial<typeof source> = {
  ...
  new: {
    ...
    client: {
      title: '請求する相手',
      description: '名簿に無い相手なら、名前と電話番号だけで請求できます。',
      kind: '相手の種類',
      unregistered: '名簿に無い相手',
      customer: '名簿にいる人',
      company: '会社',
      name: '相手の名前',
      id: '相手の管理番号',
      idPlaceholder: 'cl_...',
      customerPick: 'せいきゅうする人',
      ...
      searching: '同じ名前の人を、名簿からさがしています…',
      candidatesHint: '同じ名前の人が名簿にいます。同じ人なら、選んでください。',
      noCandidates: '同じ名前の人は、名簿にいません。新しく入れます。',
    },
    delivery: {
      title: '知らせる方法',
      description:
    ...
    validation: {
      ...
      billTo: '相手の名前を入れてください。名簿にいる相手に送るときは、管理番号も要ります。',
    },
    error: {
