...
export const settings: DeepPartial<typeof source> = {
  ...
  playWindows: {
    ...
    linkDescription: '会員の種類ごとに、プレーできる曜日と時間',
    emptyTitle: '会員の種類がありません',
    editTitle: 'プレーできる日を決める',
    noRestriction: '決まりなし',
    anyTime: 'いつでも',
    daysHint: 'ぜんぶ選ぶか、ひとつも選ばないと、曜日の決まりはなしになります。',
  },
  discounts: {
    title: '会員のわりびき',
    ...
    linkDescription: '会員の種類ごとに、料金からいくら引くか',
    emptyTitle: '会員の種類がありません',
    editTitle: 'わりびきを決める',
    none: 'わりびきなし',
    valueYen: '{{value}} 円引き',
  ...
  caddieDuties: {
    ...
    saved: 'ほぞんしました',
    failed: 'ほぞんできませんでした',
    linkDescription: 'ラウンドがない日に、キャディにたのむ仕事',
    emptyTitle: '仕事のしゅるいがありません',
    addTitle: 'しゅるいをふやす',
    editTitle: 'しゅるいを直す',
    rank: '順',
    moveUp: '上へ',
  ...
  grades: {
    ...
    linkDescription: '来た回数とお金から、常連さんをどう分けるか',
    emptyTitle: '段がありません',
    addTitle: '段をふやす',
    editTitle: '段を直す',
    sheetHint: '空らんはじょうけんになりません。',
    rank: '段',
    moveUp: '上へ',
    moveDown: '下へ',
  },
  membership: {
    ...
    linkDescription: 'この コースが 売って いる 会員の しゅるい',
    emptyTitle: '会員の しゅるいが ありません',
    addTitle: '会員の しゅるいを ふやす',
    editTitle: '会員の しゅるいを 直す',
    status: '状態',
    selling: '売って いる',
  },
  extension: {
