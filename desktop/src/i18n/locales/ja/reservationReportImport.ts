export const reservationReportImport = {
  ...
  mapping: {
    title: '施設をCourseBoardのコースに対応させる',
    description: '表の施設名ごとに、保存先のコースを1つ選びます。候補は自動で選びますが、必ず確認してください。',
    source: '表の施設',
    selected: '選択済み',
    unselected: 'コースを選んでください',
    suggested: '名前が一致した候補',
    columnTitle: '列の対応を確認する',
    columnDescription: '表の列を、CourseBoardで使う項目へ対応させた結果です。内容を確認してからコースを選びます。',
    sourceColumn: '表の列',
    targetColumn: '読み込む項目',
    confidence: '確かさ',
    samples: '例',
