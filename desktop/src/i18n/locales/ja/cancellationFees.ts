export const cancellationFees = {
  ...
  new: {
    ...
    client: {
      title: '請求先',
      description: '台帳に無い相手なら、名前と電話番号だけで請求できます。',
      kind: '請求先の種類',
      unregistered: '台帳に無い相手',
      customer: '登録ずみの個人',
      company: '法人',
      name: '請求先の名前',
      id: '取引先ID',
      ...
      searching: '同じ名前の人を探しています…',
      candidatesHint: '同じ名前の人が台帳にいます。同じ人なら選んでください。',
      noCandidates: '同じ名前の人は台帳にいません。新しく登録します。',
    },
    delivery: {
      title: '送る方法',
    ...
    validation: {
      ...
      billTo: '請求先の名前を入れてください。登録ずみの相手に送るときは、顧客IDか取引先IDが要ります。',
    },
    message: {
      intro: 'キャンセル料のご請求です。',
